...
<section class="hero-premium" style="background-image: url('https://images.unsplash.com/photo-1497935586351-b67a49e012bf?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');">
    <div class="hero-content">
        <h1 class="hero-title" style="color: white !important; font-weight: 800; text-shadow: 0 4px 15px rgba(0,0,0,0.5);">Trải nghiệm cà phê nghệ thuật</h1>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7">
                ...
                <p class="text-muted lead mb-4" style="line-height: 1.8;">Chào mừng bạn đến với <strong>Chill Coffee</strong>, nơi mỗi tách cà phê là một tác phẩm nghệ thuật. Chúng tôi nỗ lực mang đến trải nghiệm chân thực nhất từ những hạt cà phê thượng hạng...</p>
