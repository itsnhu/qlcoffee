...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $sql = "INSERT INTO suppliers (name, phone, address, created_at)
                    VALUES (?, ?, ?, NOW())";
            $params = [
                $formData['name'],
                $formData['phone'],
            ...
            setMessage('success', 'Thêm nhà cung cấp thành công!');
            redirect('/admin/suppliers/index.php');
        } catch (PDOException $e) {
            error_log("Create Supplier Error: " . $e->getMessage());
            $errors['general'] = 'Có lỗi khi thêm nhà cung cấp. Vui lòng thử lại.';
        }
    }
}
...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="" id="createSupplierForm">
                    <!-- Supplier Name -->
                    <div class="mb-3">
